...
<body>
  ...
  <form class="mgrform" action="mgrmenu.php" method="post">
      <label style="font-size:30px; margin-top: 15px"><b>Doctor:</b></label><br>
      <select required name="doctor" id="doctor-list" class="demoInputBox" style="width:100%;height:55px;border-radius:9px">
  ...
  <form class="formtable" action="mgrmenu.php" method="post">;
    <table>
      <tr>
        <th>UserName</th>
        <th>First Name</th>
